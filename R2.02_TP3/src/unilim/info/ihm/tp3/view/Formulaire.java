...
public class Formulaire extends VBox {
    ...
    private final Label typeError2 = new Label("Veuillez saisir le type (fruit/légume)");
    ...
    public Formulaire() {
        ...
        typeError2.setVisible(false);
        
        VBox typeErrors = new VBox(typeError, typeError2);
        typeErrors.setSpacing(2);
